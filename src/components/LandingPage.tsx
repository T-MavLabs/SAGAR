...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, mode, onSwitchMode, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use actual form data for user creation
      const userData = {
...
const LandingPage: React.FC<LandingPageProps> = ({ onEnter, onUserLogin, marineStats }) => {
  ...
  const handleAuthSuccess = (userData: {
    ...
    // Call onUserLogin with actual form data
    onUserLogin(userData);
  ...
  return (
    <div className="min-h-screen bg-marine-blue text-white overflow-hidden relative">
      ...
      <main className="relative z-10">
        <section className="pt-20 pb-32">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            {/* Stats - Use marineStats if provided, otherwise use default values */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
              ...
              >
                <div className="text-2xl font-bold text-marine-cyan mb-1">
                  {marineStats ? marineStats.speciesRecords.toLocaleString() : '250K+'}
                </div>
              ...
              >
                <div className="text-2xl font-bold text-marine-cyan mb-1">
                  {marineStats ? marineStats.dataContributors : '150+'}
                </div>
              ...
              >
                <div className="text-2xl font-bold text-marine-cyan mb-1">
                  {marineStats ? marineStats.researchPublications : '50+'}
                </div>
              ...
              >
                <div className="text-2xl font-bold text-marine-cyan mb-1">
                  {marineStats ? marineStats.activeCruises : '24/7'}
                </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-marine-dark border-t border-white/10 py-12">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2024 SAGAR - Spatio-temporal Analytics Gateway for Aquatic Resources. All rights reserved.</p>
          </div>
        </div>
      </footer>
